	...
	if len(args) == 1 && args[0] == "--help" {
		return write(stdout, helpView{
			...
			Commands: []string{
				...
				"task external resource archive <task-id> <resource-id> --caller-id <id> --operation-id <id> --expected-revision <revision>",
				"task external execution create <task-id> --execution-id <id> --resource <resource-id> --caller-id <id> --operation-id <id>",
				"task external execution archive <task-id> <execution-id> --caller-id <id> --operation-id <id> --expected-revision <revision>",
