...
`task execution finish` closes a managed execution created by `task execution create`, before or after the task is terminal, and it preserves managed provenance.
